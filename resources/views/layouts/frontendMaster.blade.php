...
<head>
    ...
    <!-- <link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;1,100;1,200;1,300;1,400;1,500;1,600&display=swap" rel="stylesheet"> -->
    <!-- <link href="http://fonts.cdnfonts.com/css/domaine-display" rel="stylesheet">
        <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    ...
    <!-- <link href="http://fonts.cdnfonts.com/css/rockwell-nova" rel="stylesheet">
        <link href="http://fonts.cdnfonts.com/css/slant" rel="stylesheet"> -->
...
<style type="text/css">
    ...
    .findSearch-block .searchInner {
        border: 1px solid #243233;
        box-shadow: none;
    }

    .findSearch-block .searchInner i {
        color: whiles;
    }
    ...
    .findSearch-block .searchInner button {
        background: #008FB4 !important;
        border: none;
        padding-right: 15px;
        font-size: 15px;
    ...
    .findSearch-block .searchInner input::placeholder {
        font-family: "Montserrat";
        color: #ddd;
    }
    ...
    .findSearch-block .searchInner {
        ...
        border-radius: 5px;
        box-shadow: 0 12px 15px 0 rgb(135 123 123 / 38%);
        color: #fff;
        font-size: 14px;
        text-decoration: none;
        line-height: 20px;
    ...
    .findSearch-block .searchInner input {
        padding: 8px 5px;
        width: 95%;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content {
        /* width: 100% !important;
        height: 100%;
        padding: 0;
        margin: 0;
...
<style type="text/css">
    .ujsm div#exampleModal .modal-dialog .modal-content section.nkmagicform.UserDashboardmain {
        /*position: relative;
        background: transparent;
        padding-top: 30px;*/
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .UserDashboardmain .main-register-holder {
        max-width: 100%;
        margin-top: 50px;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .link-edit i {
        padding-right: 10px;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard ul a i {
        padding-right: 10px;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .left_dashBoard {
        background: #008FB4;
        padding: 10px;
        text-align: center;
        position: relative;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .main-overlay {
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .image-dashboard img {
        width: 100%;
        height: 100%;
        object-fit: cover;
        border-radius: 100%;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .left_dashBoard h2 {
        border: 0;
        color: #333e4e;
        font-size: 1.25rem;
        margin-bottom: 0;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .left_dashBoard .free-account {
        color: white;
        margin: 0;
        text-align: center;
        display: block;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .left_dashBoard .upgrade {
        display: flex;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .left_dashBoard a {
        color: #2f3a4a;
        font-size: .875rem;
        text-decoration: underline;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .middle-dashboard {
        width: 100%;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .top-head-middle {
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .top-head-middle.top-one {
        border-bottom: 1px solid #444444;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .top-head-middle h1 {
        color: #008FB4;
        font-size: 1.25em;
        font-weight: bold;
        text-transform: capitalize;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .top-head-middle span {
        margin-top: 3.4em;
        font-size: 12px;
        color: #fff;
        font-family: 'Open Sans', sans-serif !important;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content span.link-edit {
        color: white;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .top-head-middle span i {
        margin-right: 5px;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .middle-dashboard .labels {
        min-width: 94px;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .status-label.pending {
        background: #feb219;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .listing {
        font-size: 0.9em;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .status-label {
        border-radius: 20px;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content a.listing-link {
        display: flex;
        flex: auto;
        align-items: center;
        min-width: 64px;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .link-title {
        font-size: 14px;
        width: 100%;
        overflow: hidden;
        text-overflow: ellipsis;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .link-edit svg.edit {
        color: #4f4841;
        margin-right: 10px;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .middle-info {
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .may-N h1 {
        color: #444444;
        font-size: 1.25em;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .styles__heading {
        display: flex;
        color: #2f3a4a;
        font-size: 1rem;
        line-height: 1.5rem;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .styles__subheading {
        color: #2f3a4a;
        font-size: .875rem;
        line-height: 1.25rem;
        font-weight: 400;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .iconUpload span {
        font-size: 12px;
        font-weight: 600;
        text-transform: capitalize;
        letter-spacing: 1px;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .middle-info .ButtonBase {
        display: flex;
        position: relative;
        outline: none;
        width: fit-content;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .styles__link {
        display: inline-block;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .styles__link a {
        text-decoration: underline;
        color: black;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .listing__buttons {
        display: flex;
        flex-direction: row;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .listing__buttons button {
        -webkit-box-align: center;
        align-items: center;
        flex-shrink: 0;
        position: relative;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard ul {
        list-style: none;
        padding: 0;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard ul a {
        color: white;
        font-size: 0.9em;
        padding: 0;
        text-align: left;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard ul a span.icon svg {
        height: 14px;
        margin-right: 0.5rem;
        width: 18px;
        color: #4f4841;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard .top-head-middle {
        margin: 0;
        padding: 0;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content ul.list-info li a {
        display: block;
        overflow: hidden;
        text-overflow: ellipsis;
        white-space: nowrap;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content ul.list-info li a.all-articles {
        color: #fff;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .link-edit svg.edit .fill {
        fill: #4f4841 !important;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard ul a span.icon svg .fill {
        fill: #4f4841;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard a,
    .ujsm div#exampleModal .modal-dialog .modal-content .middle-dashboard a {
        text-decoration: none;
        padding: 2px;
    }
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .right-dashboard a:hover,
    .ujsm div#exampleModal .modal-dialog .modal-content .middle-dashboard a:hover {
        color: #008fb4;
        font-weight: 700;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .UserDashboardmain .login-and-register-form .main-register {
        background: transparent;
        box-shadow: none;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .UserDashboardmain .login-and-register-form {
        background: #EAE7DC;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .main-overlay:before {
        content: "";
        position: absolute;
        left: 0;
        width: 100%;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .iupload {
        position: relative;
        width: 110px;
        height: 110px;
        margin: auto;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .iupload img {
        width: 100%;
        height: 100%;
        object-fit: cover;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .iconUpload {
        position: absolute;
        background: #162736;
        width: 100%;
        height: 25%;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .iconUpload input {
        position: absolute;
        width: 100%;
        height: 100%;
        left: 0;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content section {
        /* padding: 0rem 0rem;*/
    }
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .may-N .row {
        display: flex;
        justify-content: space-between !important;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .may-N button {
        background: #008FB4;
        color: white;
        border: none;
        padding: 5px;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .image-dashboard {
        position: absolute;
        top: -60px;
        left: 50%;
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .logo img {
        width: 150px;
    }

    .ujsm div#exampleModal .modal-dialog .modal-content .step-header {
    ...
    .ujsm div#exampleModal .modal-dialog .modal-content .modal-header div#wrapper {
        width: 100%;
    }
    ...
    .find-block-main {
        ...
        /* justify-content: flex-start; */
        align-items: center;
        background: url(https://okroomie.com/public/assets/frontend/images/bigp.jpg) !important;
        background-size: cover !important;
    ...
    li.bor_uk a:hover {
        ...
        border: 2px solid #FF5E3C !important;
        color: white !important;
        transition: 0.4s;*/
    }

    li.bor_uk a {
        border: 2px solid #243233 !important;
    }

    #navigation.style-1.head-tr ul li a:hover {
        font-weight: 600;
    ...
    .searchInner input#search-click::placeholder {
        color: white !important;
        font-size: 14px;
    }
...
<style>
    @media only screen and (max-width: 1018px) {
        ...
        .header-user-menu.nkprofilelogin {
            /* margin-left: 80px;*/
        }
    }
    ...
    .sserinput button.btn.btn-primary {
        text-align: center;
        margin: auto;
        display: block;
        margin-top: 20px;
    ...
    .ggggggg.forgat.passwword .modal-header {
        margin: auto;
        padding: 50px;
    }
    ...
    .ggggggg button.close {
        top: 0;
        position: absolute;
        right: 10px;
    }

    .myform3 .modal-header {
        display: flex;
        justify-content: space-between;
        align-items: center;
        align-content: center;
    ...
    .myform3 button.btn.btn-primary {
        text-align: center;
        margin: auto;
        display: block;
        margin-top: 20px;
    ...
    .ggggggg.chang.passwword .modal-header {
        margin: auto;
        padding: 30px;
    }
...
*/
    ...
    .middle-dashboard .top-head-middle {
        border-bottom: 1px solid #444444;
    }

    .jhggggggffff nav#socialnav .social_intro.show {
        font-size: 1.5rem;
        line-height: 1em;
    ...
    @media (max-width: 1199px) {
        #navigation.style-1.head-tr ul li .header-user-menu.nkprofilelogin a .username {
            display: none;
        }
    }
    ...
    @media (max-width: 767px) {
        ...
        .header-user-name span.img:after {
            position: absolute;
            content: "";
            height: 10px;
            width: 10px;
    ...
    .yharakl button i.fa.fa-pencil-square-o {
        margin-right: 5px;
    }
    ...
    .Findmearoomie::-webkit-scrollbar-track {
        -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);
        background-color: #2B3A48;
    }

    .Findmearoomie::-webkit-scrollbar {
        width: 10px;
        background-color: #162736;
    }

    .Findmearoomie::-webkit-scrollbar-thumb {
        background-color: #0D5068;
        border: 2px solid #0D5068;
    }
    ...
    .FindmeaRoom::-webkit-scrollbar-track {
        -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);
        background-color: #2B3A48;
    }

    .FindmeaRoom::-webkit-scrollbar {
        width: 10px;
        background-color: #162736;
    }

    .FindmeaRoom::-webkit-scrollbar-thumb {
        background-color: #0D5068;
        border: 2px solid #0D5068;
    }
...
<body class="homepage-9 hp-6 homepage-1">
    <div class="ggggggg payment_h">
        <div class="modal fade" id="exampleModalyy34" tabindex="-1" aria-labelledby="exampleModalLabelyy34" aria-hidden="true">
    ...
    <div class="ggggggg">
        ...
        <!-- Modal -->
        <div class="modal fade" id="exampleModalyy" tabindex="-1" aria-labelledby="exampleModalLabelyy" aria-hidden="true">
                            ...
                            <div class="sserinput">
                                <form id="updatePersonalData">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="your_first_name" class="form-control" id="your_first_name_input" aria-describedby="emailHelp">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="allowed_verified_members_to_contact" class="form-check-input" id="allowed_verified_members_to_contact">
                                        <label class="form-check-label" for="exampleCheck1">Allow verified members to contact me on my mobile (recommended)</label>
                                    </div>
                                    <button type="submit" class="btn btn-primary">Save my changes</button>
                                    <!-- <button type="submit" class="btn ">Save my changes</button> -->
                                    <div class="slpoi">
                                        <a href="" class="hahu" href="#" type="button" data-toggle="modal" data-target="#exampleModalyyyy"> Change password</a>
    ...
    <div class="ggggggg">
        <!-- Button trigger modal -->
        <!-- Modal -->
        <div class="modal fade" id="exampleModalyyy" tabindex="-1" aria-labelledby="exampleModalLabelyyy" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="myform3">
                            <div class="newfform">
                                <form id="verifymobilenumber">
                                    ...
                                    <p class="tyyt">For the security of our community, all members are required to verify a mobile number when creating a listing.</p>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Mobile number</label> <a href="javascript:;" onclick="resendotp()">Resend OTP</a>
                                    ...
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="allowed_verified_members_to_contact" class="form-check-input" id="exampleCheck1">
                                        <label class="form-check-label" for="exampleCheck1">Allow verified members to contact me on my mobile</label>
                                    </div>
    ...
    <div class="ggggggg chang passwword">
        <!-- Button trigger modal -->
        <!-- Modal -->
        <div class="modal fade" id="exampleModalyyyy" tabindex="-1" aria-labelledby="exampleModalLabelyyyy" aria-hidden="true">
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
    ...
    <div class="ggggggg forgat passwword">
        <!-- Button trigger modal -->
        <!-- Modal -->
        <div class="modal fade" id="exampleModalyyyyy" tabindex="-1" aria-labelledby="exampleModalLabelyyyyy" aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                ...
                                                <div class="right-dashboard">
                                                    <div class="rightcommon">
                                                        ...
                                                        <div class="content-data">
                                                            <ul>
                                                                <li class="liext">
                                                                    <a href="#" class="verify-phone" data-toggle="modal" data-target="#exampleModalyyy">
                                                                        <span class="icon">
                                                                ...
                                                                <li class="liext">
                                                                    <a href="javascript:;" onclick="myAccountSetting()" data-toggle="modal" data-target="#exampleModalyy">
                                                                        <span class="icon">
                                                                ...
                                                                <li class="liext">
                                                                    <a href="javascript:;" onclick="getPaymentData()" data-toggle="modal" data-target="#exampleModalyy34">
                                                                        <span class="icon">
                                                ...
                                                <div class="tiranga-hmara">
                                                    ...
                                                    <div class="middle-dashboard">
                                                        <div class="may-N">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-6 extttt">
                                                                    <a href="{{url('find-me-a-roomie/index')}}"><button>+ List Your Space</button></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="top-head-middle top-one">
                                                            ...
                                                            @endphp
                                                            <h1 class="fir_choya"> <i class="fa fa-user-circle-o" aria-hidden="true"></i> Find me a roomie </h1>
                                                        </div>
                                                        @if($find_me_a_roomie != '')
                                                        <div class="Findmearoomie">
                                                            ...
                                                            <div class="yharakl">
                                                                ...
                                                                @if(isset($roomie_image->image))
                                                                <div class="lookoi">
                                                                    <a href="{{url('/find-me-a-roomie/EditListing/'.encrypt($val->id))}}"><button><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</button></a>
                                                                </div>
                                                                @else
                                                                <div class="lookoi">
                                                                    <a href="{{url('/find-me-a-roomie/index/'.$val->id)}}"><button><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Resume</button></a>
                                                                </div>
                                                                @endif
                                                            </div>
                                                            @endforeach
                                                        ...
                                                        <a href="https://www.okroomie.com/find-me-a-roomie/index">
                                                            <h4 class="full_tack">You don’t have any property listings <span>+ Create</span></h4>
                                                        </a>
                                                        @endif
                                                    </div>
                                                    <div class="middle-dashboard">
                                                        <div class="top-head-middle">
                                                            <h1 class="fir_choya"><i class="fa fa-home" aria-hidden="true"></i> Find me a Room</h1>
                                                        </div>
                                                        @if($find_me_a_room != '')
                                                        <div class="FindmeaRoom">
                                                            ...
                                                            <div class="yharakl">
                                                                ...
                                                                @endif
                                                                <p>{{$val->suburb}}</p>
                                                                <a href="{{url('/find-me-a-room/EditListing/'.encrypt($val->id))}}"><button><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</button></a>
                                                            </div>
                                                            @endforeach
                                                        </div>
                                                        @else
                                                        <a href="https://www.okroomie.com/find-me-a-room/index">
                                                            <h4 class="full_tack">You don’t have a person listing <span>+ Create</span></h4>
                                                        </a>
                                                        @endif
                                                        @endif
                                                    </div>
                                                ...
                                                <div class="left_dashBoard">
                                                    <div class="image-dashboard">
                                                        ...
                                                        <form id="imageUploadForm">
                                                            ...
                                                            <div class="iupload">
                                                                @if(Auth::user()->image)
                                                                <img src="{{url('storage/app')}}/{{Auth::user()->image}}" id="blah" alt="your image" />
                                                                @else
                                                                <img id="blah" src="https://cdn.pixabay.com/photo/2017/03/27/13/28/man-2178721_960_720.jpg" alt="your image" />
                                                                @endif
                                                    ...
                                                    <a href="{{route('documentType')}}" class="btn upgrade">Verify your ID</a>
                                                    <a href="javascript:;" id="pauseplan" onclick="PausePlan()" class="btn upgrade">Pause Plan</a>
                                                    <a href="javascript:;" id="resumeplan" onclick="resumePlan()" class="btn upgrade">Resume Plan <small id="remaining_days"> </small></a>
                    ...
                    <div class="header-search">
                        <div id="search" class="search1">
                            <div class="findSearch-block">
                                <form>
                                    ...
                                    <div class="searchInner" data-toggle="modal" data-target="#exampleModalumesh">
                                        ...
                                        <input type="text" name="" placeholder="Enter your Suburb, location, or postcodes" id="search-click" />
                            ...
                            <div class="popoinng_rock">
                                ...
                                <div class="modal fade" id="exampleModalumesh" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
  ...
  <path d="M10.828.122A.5.5 0 0 1 11 .5V1h.5A1.5 1.5 0 0 1 13 2.5V15h1.5a.5.5 0 0 1 0 1h-13a.5.5 0 0 1 0-1H3V1.5a.5.5 0 0 1 .43-.495l7-1a.5.5 0 0 1 .398.117zM11.5 2H11v13h1V2.5a.5.5 0 0 0-.5-.5zM4 1.934V15h6V1.077l-6 .857z"/>
                                ...
                                <li>
                                    ...
                                    @auth
                                    <div class="faly">
                                        <div class="header-user-menu user-menu add nkprofilelogin"> @if(isset(Auth::user()->image))
                                            <div class="header-user-name dashmenu">
                                                <a data-toggle="modal" onclick='return check()' data-target="#exampleModal" href="#">
                                                    <span class="position-relative img">
                                                        <img src="{{url('storage/app/').'/'.Auth::user()->image}}" alt="">
                                                    </span>
    ...
    <!-- <div class="popoinng_rock">
        ...
        <div class="modal fade" id="exampleModalumesh2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
    ...
    <!--  @auth
            <div class="header-user-menu user-menu add nkprofilelogin">
                ...
                <div class="header-user-name dashmenu">
                    <span><img src="storage/app/{{Auth::user()->image}}" alt=""></span>
                    <a href="{{url('dashboard')}}">Hi,{{ Auth::user()->your_first_name}}!</a>
                </div>
                @else
                <div class="header-user-name dashmenu">
                    <span><img src="storage/app/dummy.jpg" alt=""></span>
                    <a href="{{url('dashboard')}}">Hi,{{ Auth::user()->your_first_name}}!</a>
                </div>
                @endif
    ...
    <!--    @guest
            <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                ...
                <div class="header-widget sign-in">
                    ...
                    <div class="show-reg-form"><a href="{{url('login')}}">Login</a></div>
    ...
    <!-- Right Side Content / End -->
    <!--  @auth
            <div class="header-user-menu user-menu d-xl-flex">
            
                <div class="lang-wrap">
            
                    <div class="show-lang"><span><strong>Message</strong></span></div>
    ...
    <!-- <div class="header-user-menu user-menu d-xl-flex">
            <div class="lang-wrap">
                @if(Session::has('blockUser'))
                <div class="alert alert-danger" id="block-user-message"><span><strong>{{Session::get('blockUser')}}</strong></span></div>
                @endif
                 <div class="show-lang"><span><strong>Favorite</strong></span></div>
    ...
    <!--  <div class="header-user-menu user-menu d-xl-flex">
            <div class="lang-wrap">
                ...
                <div class="show-lang"><span><strong>Help</strong></span></div>
    ...
    <section>
        <div class="row cookies" id="cookiesss" style="display: none;">
            <div class="col-md-10">
                <p>We use cookies to perform analytics and to provide you with personalised content and ads that are tailored to your interests. Our iOS Apps have been tailored to meet Apple’s App Tracking Transparency requirements, meaning that these apps do not track our iOS App users for the purposes of personalised or targeted advertising. By clicking "Continue", you accept our use of cookies as outlined in our <a href="{{url('cookie_policy')}}">Cookie Policy</a>.</p>
            </div>
            <div class="col-md-2">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="text-white mb-0">OkRoomie is a marketplace community that brings together room mates and room owners to achieve a similar aim.</p>
            ...
            <div class="main-register fl-wrap">
                ...
                <div class="soc-log fl-wrap">
                    ...
                    <a href="{{route('login.google')}}" class="google-log">
                        <!-- <i class="fa fa-google"></i> --><img src="https://okroomie.com/public/assets/frontend/images/g-png.png" width="25" class="mr-2"> Log in with Google
                    </a>
                </div>
                        ...
                        <div class="tab">
                            <div id="tab-2" class="tab-contents">
                                <div class="custom-form">
                                    ...
                                    <form method="post" name="registerform" id="form-register" class="main-register-form" id="main-register-form2">
                                        @csrf
    ...
    <!-- Cookies start -->
    <!-- <script>
        let cookiess = getCookie("user_cookie_consent");

        if (cookiess != "") {
            alert();
            document.getElementById("cookiesss").style.display = "none";
        } else {
            document.getElementById("cookiesss").style.display = "block";
            alert('avdhesh');
        }
    </script>
    <script>
