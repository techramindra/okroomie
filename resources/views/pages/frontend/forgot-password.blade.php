                ...
                <div class="main-register fl-wrap">
                   ...
                   <!--  <div class="log-separator fl-wrap"><span>Or</span></div> -->
                    ...
                    <div id="tabs-container">
                        ...
                        <x-auth-session-status class="mb-4 textcolorsuccess" :status="session('status')" />
                        <x-auth-validation-errors class="mb-4 textcolorerror" :errors="$errors" />
                        <div class="custom-form">
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="errror"><p id="error_email_login"></p></div>
                               ...
                               <div class="log-submitBtn">
                                    <button type="submit" class="log-submit-btn"><span>Email Password Reset link</span></button>
                               </div>
