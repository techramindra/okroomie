                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="mg-jh">
                        ...
                        <ul class="nav nav-tabs nav-justified" role="tablist" id="nvm">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="https://okroomie.com/helpcenter/how_to_s">How to's </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="https://okroomie.com/helpcenter/current-articles">Current Articles</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="https://okroomie.com/helpcenter/agreements-and-legal-info"> Agreements and legal</a>
                            </li>
