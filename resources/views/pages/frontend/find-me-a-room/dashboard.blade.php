...
<head>
    ...
    <style type="text/css">
        ...
        .some_sub_section ul.sub_class li small {
            font-size: 1rem;
        }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">jacks number is</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="jacks_numberm">
                    <p class="jk_numer"> +61 987654332</p>
                        ...
                        <div class="row">
                            <div class="col-md-6 pr-0">
                                <div class="left__image">
                                    <img class="lightboxed" rel="group1" src="{{url('public/images/'.$user_images[0]->image)}}" data-link="{{url('public/images/'.$user_images[0]->image)}}" alt="Image Alt" data-caption="Image Caption" />
                                </div>
                            </div>
                                ...
                                <div class="message__inner__box">
                                    ...
                                    <div class="top__user">
                                        ...
                                        <div class="may_number">
                                            <a href="" data-toggle="modal" data-target="#exampleModalDDd">show {{$user->your_first_name}}</a>
                                        </div>
                                    </div>

                                    <form id="sendMessage">
                                        <input type="hidden" name="ids" value="{{$data->id}}">
                                        <input type="hidden" name="room_roomie" value="room">
