...
<section class="bg__blue">
            <div class="container">
                <div class="stepsecond">
                    ...
                    <form id="step-1" action="{{url('find-me-a-room/step-7')}}" method="post">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 m-auto">
                                <div id="radioset" class="custumradiosetone custumradiosetten">
                                    <div class="cRadiosub">
                                        <input type="checkbox" class="steprd" id="radio1" name="lgbt" value="1" {{$data->lgbt==1 ? "checked" : ""}} >
                                        <label for="radio1">
                                    ...
                                    <div class="cRadiosub">
                                        <input type="checkbox" class="steprd" value="1" {{$data->pets==1 ? "checked" : ""}} id="radio2" name="pets" >
                                        <label
                                            for="radio2">
                                    ...
                                    <div class="cRadiosub">
                                        <input type="checkbox" class="steprd" value="1" {{$data->smokers==1 ? "checked" : ""}} id="radio3" name="smokers">
                                        <label for="radio3">
                                    ...
                                    <div class="cRadiosub">
                                        <input type="checkbox" class="steprd" value="1" {{$data->children==1 ? "checked" : ""}} id="radio4" name="children">
                                        <label for="radio4">
                                ...
                                <div class="stepbutton">
                                    ...
                                    <a href="{{url('find-me-a-room/step-6')}}">Back</a> 
                                </div>
                            </div>
                        </div>
                    </div>
