                          ...
                          <div class="row">
                              <div class="col-md-8 m-auto">
                                  ...
                                  <div class="stepbutton">
                                    ...
                                    <!-- <a href="{{url('find-me-a-room/step-9/')}}" id="livebutton" style="color:white;"> -->
                                    ...
                                    <a  href="javascript:;" onclick="checkValidation()"  id="livebutton" style="color:white;">    
                                      ...
                                      <a href="{{url('find-me-a-room/step-7')}}">Back</a>
                                  </div>
                              </div>
                          </div>
                      </div>
...
function checkValidation()
{
    ...
    else
    {
        ...
        newurl=url+'/find-me-a-room/step-9/';
...
function deleteImage(id)
{
  ...
  $.post("{{url('deleteUserImages')}}",{id:id,_token:token},function(data){
   $("#imageid"+id).remove();
