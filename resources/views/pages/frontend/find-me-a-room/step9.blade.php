        ...
        <header class="step-header">
            <div class="container">
                <div class="inner-block">
                    <div class="left">
                        <a href="{{url('find-me-a-room/step-8')}}">Left</a>
                    </div>
                    <div class="logo">
                        <a href="{{url('/')}}">
...
<section>
            <div class="container">
                <div class="stepthird">
                    ...
                    <form id="step-1" action="{{url('find-me-a-room/step-9')}}" method="post">
                        @csrf
                    <div class="stepradio">
                        <div class="row">
                            <div class="col-md-6 m-auto">
                                ...
                                <div class="stepform form-group">
                                    ...
                                    <div class="input-group mb-3">
                                       <textarea name="about_yourself" id=""  rows="5" class="form-control" placeholder="Say something about yourself...">{{$data->about_yourself}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="stepbutton">
                                    <a href="{{url('find-me-a-room/step-10')}}">
                                        <button>
                                            Next
                                        </button>
                                    </a>

                                    <a href="{{url('find-me-a-room/step-8')}}">Back</a> 
                                </div>
                            </div>
                        </div>
                    </div>
