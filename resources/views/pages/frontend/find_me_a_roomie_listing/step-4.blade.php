...
.bglk {
    padding: 5px 34px;
    /* border-radius: 30px; */
    background-color: #ACD8E3 !important;
    border-radius: 30px;
    margin: 0 5px;
        ...
        <header class="step-header">
            <div class="container">
                <div class="inner-block">
                    <div class="left">
                        <!--  <a href="{{url('find-me-a-roomie/step-5')}}">Left</a> -->
                    </div>
                    <div class="logo">
                        <a href="{{url('/')}}">
        ...
        <section class="bg__blue">
            <div class="container">
                <div class="stepthird mt-5">
                    ...
                    <br>
                    <form action="{{url('find-me-a-roomie/step-44')}}" method="post">
                        @csrf
                        <div class="row">
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48"><rect x="0" y="0" width="48" height="48" fill="none" stroke="none" /><g fill="none"><rect width="40" height="30" x="4" y="6" stroke="#fff" stroke-width="4" rx="2"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M38 15h-4m4 6h-4m-24-6h17v12H10z"/><circle cx="36" cy="27" r="2" fill="#fff"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M12 36v6m24-6v6"/></g></svg></span>
                                                <span>microwave</span>
                                            </div>
                                        </label>
                                    </div>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><path fill="#fff" d="M20 14.27V10c0-4.42-3.58-8-8-8s-8 3.58-8 8v4.27c-.6.34-1 .99-1 1.73v4c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-4c0-.74-.4-1.39-1-1.73zM7 20H5v-4h2v4zm4 0H9v-4h2v4zm0-6H6v-4c0-2.97 2.16-5.44 5-5.92V14zm2-9.92A6 6 0 0 1 18 10v4h-5V4.08zM15 20h-2v-4h2v4zm4 0h-2v-4h2v4zM8 11c0-.55.45-1 1-1s1 .45 1 1s-.45 1-1 1s-1-.45-1-1zm8 0c0 .55-.45 1-1 1s-1-.45-1-1s.45-1 1-1s1 .45 1 1z"/></svg></span>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M22 3.6V11H2V3.6a.6.6 0 0 1 .6-.6h18.8a.6.6 0 0 1 .6.6ZM18 7h1M2 11l.79 2.584A2 2 0 0 0 4.702 15H6m16-4l-.79 2.584A2 2 0 0 1 19.298 15H18m-8.5-.5s0 7-3.5 7m8.5-7s0 7 3.5 7m-6-7v7"/></svg></span>
                                ...
                                <div class="main_data2">
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="#fff" d="M12 6c3.537 0 6.837 1.353 9.293 3.809l1.414-1.414C19.874 5.561 16.071 4 12 4c-4.071.001-7.874 1.561-10.707 4.395l1.414 1.414C5.163 7.353 8.463 6 12 6zm5.671 8.307c-3.074-3.074-8.268-3.074-11.342 0l1.414 1.414c2.307-2.307 6.207-2.307 8.514 0l1.414-1.414z"/><path fill="#fff" d="M20.437 11.293c-4.572-4.574-12.301-4.574-16.873 0l1.414 1.414c3.807-3.807 10.238-3.807 14.045 0l1.414-1.414z"/><circle cx="12" cy="18" r="2" fill="#fff"/></svg></span>
                                                <span>Wi-Fi</span>
                                            </div>
                                        </label>
                                    </div>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48"><rect x="0" y="0" width="48" height="48" fill="none" stroke="none" /><g fill="none"><rect width="32" height="40" x="8" y="4" stroke="#fff" stroke-width="4" rx="2"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="4" d="M8 15.5h32"/><circle cx="28" cy="10" r="2" fill="#fff"/><circle cx="34" cy="10" r="2" fill="#fff"/><circle cx="24" cy="30" r="7" stroke="#fff" stroke-width="4"/></g></svg></span>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <div class="bglk">
                                            <span><i class="fa"></i></span>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48"><rect x="0" y="0" width="48" height="48" fill="none" stroke="none" /><g fill="none" stroke="#fff" stroke-linejoin="round" stroke-width="4"><rect width="28" height="36" x="9" y="4" rx="2"/><path stroke-linecap="round" d="M9 22h28M9 20v4m28-4v4m-22 5v4m0-22v4m18 25v4m-20-4v4"/></g></svg></span>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><path fill="#fff" d="M12 22H6a2 2 0 0 1 2-2V8H2V5h14v3h-6v12a2 2 0 0 1 2 2M22 2v20h-2v-7h-5v7h-2v-8a2 2 0 0 1 2-2h5V2Z"/></svg></span>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><g fill="none" stroke="#fff" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8.5 14.5L5 22M8 6s1-1.061 1-2c0-1.333-1-2-1-2m4 4s1-1.061 1-2c0-1.333-1-2-1-2m4 4s1-1.061 1-2c0-1.333-1-2-1-2"/><path stroke-linejoin="round" d="M16.5 17.5h-9"/><path stroke-linecap="round" stroke-linejoin="round" d="m15.5 14.5l2.1 4.5m.9 3a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3Z"/><path d="M12 15a7 7 0 0 0 6.975-6.4a.563.563 0 0 0-.575-.6H5.6a.563.563 0 0 0-.575.6A7 7 0 0 0 12 15Z"/></g></svg></span>
                                                <span>BBQ Area</span>
                                            </div>
                                        </label>
                                    </div>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <span><i class="fa"></i></span>
                                                ...
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><g fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path d="M7.4 7H4.6a.6.6 0 0 0-.6.6v8.8a.6.6 0 0 0 .6.6h2.8a.6.6 0 0 0 .6-.6V7.6a.6.6 0 0 0-.6-.6Zm12 0h-2.8a.6.6 0 0 0-.6.6v8.8a.6.6 0 0 0 .6.6h2.8a.6.6 0 0 0 .6-.6V7.6a.6.6 0 0 0-.6-.6Z"/><path d="M1 14.4V9.6a.6.6 0 0 1 .6-.6h1.8a.6.6 0 0 1 .6.6v4.8a.6.6 0 0 1-.6.6H1.6a.6.6 0 0 1-.6-.6Zm22 0V9.6a.6.6 0 0 0-.6-.6h-1.8a.6.6 0 0 0-.6.6v4.8a.6.6 0 0 0 .6.6h1.8a.6.6 0 0 0 .6-.6ZM8 12h8"/></g></svg></span>
                                                <span>gym Area</span>
                                            </div>
                                        </label>
                                    </div>
                                    ...
                                    <div class="main__contact">
                                        ...
                                        <label>
                                            ...
                                            <div class="bglk">
                                            <span><i class="fa"></i></span>
                                                <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><path fill="#fff" d="M19 17c1.21 0 3-.8 3-3s-1.79-3-3-3h-2V9h2c2.2 0 3-1.79 3-3c0-2.2-1.79-3-3-3h-2V2h-1v1H8V2H7v1H2v2h5v2H5c-1.21 0-3 .8-3 3s1.79 3 3 3h2v2H5c-1.21 0-3 .8-3 3s1.79 3 3 3h2v1h1v-1h8v1h1v-1h5v-2h-5v-2h2m0-4c.45 0 1 .19 1 1s-.55 1-1 1h-2v-2h2m-3-2H8V9h8v2m3-6c.45 0 1 .2 1 1c0 .45-.19 1-1 1h-2V5h2M8 5h8v2H8V5m-3 6c-.45 0-1-.19-1-1s.55-1 1-1h2v2H5m3 2h8v2H8v-2m-3 6c-.45 0-1-.19-1-1s.55-1 1-1h2v2H5m11 0H8v-2h8v2Z"/></svg></span>
                                                <span>heating</span>
                                            </div>
                                        </label>
                                    </div>
                        ...
                        <!--  <form id="step-6-form" action="{{url('find-me-a-roomie/step-6')}}" method="post">
                        @csrf
                        <div class="stepradio">
                            <div class="row">
                        ...
                        <!-- <div class="steptworadio" id="steptworadio">
                                        ...
                                        <div id="radioset2" class="custumradiosettwo">
                                            <div class="cRadiosub">
                                                <input type="radio" {{$data->bedsize=="Single" ? "checked" : ""}} id="radio10" value="Single" name="bedsize" class="steprd">
                                                <label for="radio10">
                                                <span>Single</span> 
                                                </label>
                                            </div>
                                            <div class="cRadiosub">
                                                <input type="radio" {{$data->bedsize=="Double" ? "checked" : ""}} id="radio11" value="Double" name="bedsize"  class="steprd">
                                                <label
                                                    for="radio11">
                                                <span>Double</span>
                                                </label>
                                            ...
                                            <div class="cRadiosub">
                                                <input type="radio" {{$data->bedsize=="Queen" ? "checked" : ""}} id="radio12" value="Queen" name="bedsize"  class="steprd">
                                                <label
                                                    for="radio12">
                                                <span>Queen</span>
                                                </label>
                                            ...
                                            <div class="cRadiosub">
                                                <input type="radio" {{$data->bedsize=="King" ? "checked" : ""}} id="radio13" value="King" name="bedsize"  class="steprd">
                                                <label
                                                    for="radio13">
                                                <span>king</span>
                                                </label>
                                            ...
                                            <div class="cRadiosub">
                                                <input type="radio" {{$data->bedsize=="None" ? "checked" : ""}} id="radio14" value="None" name="bedsize"  class="steprd">
                                                <label
                                                    for="radio14">
                                                <span>None</span>
                                                </label>
                        ...
                        <!--  <div id="radioset" class="custumradiosetone xdstep-1">
                                    <div class="ccheckboxsub">
                                            <input type="checkbox" {{$data->kitchen=="1" ?"checked" : ""}} value="1" id="checkbox81" name="kitchen" class="steprd">
                                        ...
                                        <div class="ccheckboxsub">
                                            <input type="checkbox" {{$data->tv=="1" ?"checked" : ""}} value="1" id="checkbox82" name="tv" class="steprd">
                                        ...
                                        <div class="ccheckboxsub">
                                            <input type="checkbox" {{$data->security_cameras=="1" ?"checked" : ""}} value="1" id="checkbox83" name="security_cameras" class="steprd">
                                        ...
                                        <div class="ccheckboxsub">
                                            <input type="checkbox" {{$data->wifi=="1" ?"checked" : ""}} value="1" id="checkbox84" name="wifi" class="steprd">
                                        ...
                                        <div class="ccheckboxsub">
                                            <input type="checkbox" {{$data->hot_tub=="1" ?"checked" : ""}} value="1" id="checkbox85" name="hot_tub" class="steprd">
                                        ...
                                        <div class="ccheckboxsub">
                                            <input type="checkbox" {{$data->washing_mashine=="1" ?"checked" : ""}} value="1" id="checkbox86" name="washing_mashine" class="steprd">
                        ...
                        <input type="hidden" name="completed_step" value="4">
                        <input type="hidden" value="{{$data->id}}" name="_rowid" >
                        <div class="stepbutton">
                            <a href="{{url('find-me-a-roomie/7/'.encrypt(207))}}">
                                <button>
                                    Next
                                </button>
                            </a>
                            <a href="{{url('find-me-a-roomie/3/'.encrypt(203).'/'.$data->id)}}">Back</a>
