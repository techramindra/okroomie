...
.facility_details {display: flex;}

.sub__title_room h3 {
    text-transform: capitalize;
}

.facility_details div#lastoop ul.uk {display: flex;}



.facility_details div#lastoop ul.uk li .main_public {display: flex;justify-content: center;align-content: center;}

.facility_details div#lastoop ul.uk li .main_public span {margin-left: 5px;}
  ...
  font-weight: 500;
            ...
            .title__room {display: flex;justify-content: space-between;width: 73%;}

.title__room div#ukroom_de {display: flex;justify-content: center;align-content: center;}

.title__room div#ukroom_de span {margin-left: 10px;}
    ...
    outline: none;
            ...
            .mmmkh {display: flex;justify-content: space-between;align-content: center;}

.mmmkh .condhhh {width: 48%;display: flex;}

.mmmkh .condhhh span {margin-left: 10px;}
...
ul.my-new-ul {border: 1px solid #D4D7DC;border-radius: 5px;}
                                ...
                                <div class="col-md-6 pr-0">
                                    <div class="left__image">
                                        <img
                                            class="lightboxed"
                                            rel="group1"
                                            src="{{url('public/images/'.$room_image[0]->image)}}"
                                            data-link="{{url('public/images/'.$room_image[0]->image)}}"
                                            alt="Image Alt"
...
<strong></strong></li>
                                ...
                                <div class="room__details">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="sub__room__details">
                                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path fill="#7a7875" d="M4.325 9h15.35l-.85-3H5.2ZM12 7.5Zm4.8 3.5H7.225l-.275 2h10.1ZM4 20l1.225-9H3q-.5 0-.788-.4q-.287-.4-.162-.875l1.425-5q.1-.325.35-.525q.25-.2.6-.2h15.15q.35 0 .6.2t.35.525l1.425 5q.125.475-.162.875q-.288.4-.788.4h-2.2l1.2 9h-2l-.675-5H6.675L6 20Z"/></svg>
                                        ...
                                        <li>
                                            <div class="sub__room__details">
                                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48"><rect x="0" y="0" width="48" height="48" fill="none" stroke="none" /><g fill="none" stroke="#797875" stroke-linejoin="round" stroke-width="4"><rect width="28" height="36" x="9" y="4" rx="2"/><path stroke-linecap="round" d="M9 22h28M9 20v4m28-4v4m-22 5v4m0-22v4m18 25v4m-20-4v4"/></g></svg>
                                        ...
                                        <li>
                                            <div class="sub__room__details">
                                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><g fill="none" stroke="#797875" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M8.5 14.5L5 22M8 6s1-1.061 1-2c0-1.333-1-2-1-2m4 4s1-1.061 1-2c0-1.333-1-2-1-2m4 4s1-1.061 1-2c0-1.333-1-2-1-2"/><path stroke-linejoin="round" d="M16.5 17.5h-9"/><path stroke-linecap="round" stroke-linejoin="round" d="m15.5 14.5l2.1 4.5m.9 3a1.5 1.5 0 1 0 0-3a1.5 1.5 0 0 0 0 3Z"/><path d="M12 15a7 7 0 0 0 6.975-6.4a.563.563 0 0 0-.575-.6H5.6a.563.563 0 0 0-.575.6A7 7 0 0 0 12 15Z"/></g></svg>
                                                <span>BBQ Area</span>
                                            </div>
                                        </li>
                                        @endif
                                        ...
                                        <li>
                                            <div class="sub__room__details">
                                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><rect x="0" y="0" width="24" height="24" fill="none" stroke="none" /><path fill="#797875" d="M19 17c1.21 0 3-.8 3-3s-1.79-3-3-3h-2V9h2c2.2 0 3-1.79 3-3c0-2.2-1.79-3-3-3h-2V2h-1v1H8V2H7v1H2v2h5v2H5c-1.21 0-3 .8-3 3s1.79 3 3 3h2v2H5c-1.21 0-3 .8-3 3s1.79 3 3 3h2v1h1v-1h8v1h1v-1h5v-2h-5v-2h2m0-4c.45 0 1 .19 1 1s-.55 1-1 1h-2v-2h2m-3-2H8V9h8v2m3-6c.45 0 1 .2 1 1c0 .45-.19 1-1 1h-2V5h2M8 5h8v2H8V5m-3 6c-.45 0-1-.19-1-1s.55-1 1-1h2v2H5m3 2h8v2H8v-2m-3 6c-.45 0-1-.19-1-1s.55-1 1-1h2v2H5m11 0H8v-2h8v2Z"/></svg>
                                                <span>Heating</span>
                                            </div>
                                        </li>
                                        @endif
                                ...
                                <div class="room__details">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="sub__room__details">
                                            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20"><path fill="#7a7875" d="M2 6.75A2.75 2.75 0 0 1 4.75 4h10.5A2.75 2.75 0 0 1 18 6.75v6.5A2.75 2.75 0 0 1 15.25 16H4.75A2.75 2.75 0 0 1 2 13.25v-6.5ZM4.75 5A1.75 1.75 0 0 0 3 6.75v6.5c0 .966.784 1.75 1.75 1.75h10.5A1.75 1.75 0 0 0 17 13.25v-6.5A1.75 1.75 0 0 0 15.25 5H4.75ZM11 6.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-.793l-1.646 1.647a.5.5 0 0 1-.708-.708L12.293 7H11.5a.5.5 0 0 1-.5-.5Zm-2.354 4.146a.5.5 0 0 1 .708.708L7.707 13H8.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 1 1 0v.793l1.646-1.647Z"/></svg>
