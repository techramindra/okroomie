               ...
               <div class="row">
                   <div class="col-md-6 m-auto">
                    <div class="short-Details">
                        <h1>
                           My name is Elle and I will help you today with your room search !
                        </h1>
                        <div class="img-block-step">
                            <img src="{{url('public/assets/frontend/images/userroom.png')}}" alt="">
                           
                        </div>
                        <h2>I will need a few details about you</h2>
                      <!--   <p>(Rooms, Amenities, Bathroom and so on..)</p> -->
                        <!-- <span class="steppage">
                            1 of 3
                        </span> -->
                        <div class="stepbutton mt-4">
                            <a href="{{url('find-me-a-room/step-1')}}">
                                <button>
                                    Lets Begin
                                </button>
                             </a>
