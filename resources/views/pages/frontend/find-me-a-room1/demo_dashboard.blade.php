                                ...
                                <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel1">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="img_div">
                                                <img class="card-img-top" src="https://cdn.pixabay.com/photo/2017/11/02/14/27/model-2911332_960_720.jpg" alt="Card image cap" />
                                            </div>
                                        </div>
                            ...
                            <div class="imgc">
                                <div id="carouselExampleControls3" class="carousel slide" data-ride="carousel1">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="img_div">
                                                <img class="card-img-top" src="https://cdn.pixabay.com/photo/2016/10/15/05/02/girls-1741925_960_720.jpg" alt="Card image cap" />
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="img_div">
                            ...
                            <div class="imgc">
                                <div id="carouselExampleControls4" class="carousel slide" data-ride="carousel1">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="img_div">
                                                <img class="card-img-top" src="https://cdn.pixabay.com/photo/2012/02/23/10/40/concentration-16032_960_720.jpg" alt="Card image cap" />
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="img_div">
                            ...
                            <div class="imgc">
                                <div id="carouselExampleControls5" class="carousel slide" data-ride="carousel1">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="img_div">
                                                <img class="card-img-top" src="https://cdn.pixabay.com/photo/2018/01/13/19/39/fashion-3080644_960_720.jpg" alt="Card image cap" />
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="img_div">
