                                ...
                                <div class="col-md-7 m-auto h-80">
                                        ...
                                        <div class="cRadiosub">
                                            ...
                                            <label for="radio1">
                                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 20 20">
                                                    <path fill="#fff" d="M12.487 10a.75.75 0 1 1-1.5 0a.75.75 0 0 1 1.5 0ZM9.605 2.014A.5.5 0 0 0 9 2.502v15a.5.5 0 0 0 .605.489l7-1.501a.5.5 0 0 0 .394-.49V4a.5.5 0 0 0-.395-.488l-7-1.499ZM10 16.883V3.12l6 1.285v11.192l-6 1.286Zm-1.998.115v-1H4V4.003h4.002v-1H3.5a.5.5 0 0 0-.5.5v12.995a.5.5 0 0 0 .5.5h4.502Z" />
                                                </svg>
                                            </label>
                                        ...
                                        <div class="cRadiosub">
                                            ...
                                            <label for="radio4">
                                                <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                                    <path fill="#fff" d="M3 13h1v7c0 1.103.897 2 2 2h12c1.103 0 2-.897 2-2v-7h1a1 1 0 0 0 .707-1.707l-9-9a.999.999 0 0 0-1.414 0l-9 9A1 1 0 0 0 3 13zm9-8.586l6 6V15l.001 5H6v-9.586l6-6z" />
                                                    <path fill="#fff" d="M12 18c3.703 0 4.901-3.539 4.95-3.689l-1.9-.621c-.008.023-.781 2.31-3.05 2.31c-2.238 0-3.02-2.221-3.051-2.316l-1.899.627C7.099 14.461 8.297 18 12 18z" />
                                                </svg>
                                            </label>
                                            <span>Homestay</span>
                                        </div>
                                    ...
                                    <div class="stepform form-group">
                                        ...
                                        <select name="internet" id="internet" class="form-control">
                                            ...
                                            <option value="Room with a view Room with Ensuite"> Room with a view Room with Ensuite</option>

                                            <option value="Beautiful Cozy Room">Beautiful Cozy Room</option>


                                            <option value="Room in a Perfect location">Room in a Perfect location</option>
                                            <option value="Feel at home">Feel at home</option>
