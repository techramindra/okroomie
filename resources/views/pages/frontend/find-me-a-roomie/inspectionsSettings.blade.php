...
.umesht {width: 100%;margin: 20px 0px;}


div#dreat i.fa.fa-trash-o {margin-right: 5px;font-size: 20px;}



div#jkmg input {
    border: 1px solid #80D6DB;color: gray;padding: 10px 20px; outline: none;}
</style>
<body>
    <div id="wrapper">
    ...
    <!-- <div class="title__block">
            ...
            <div class="container xdstep-1">
                <div class="stepsecond mt-5">
                    <div class="titlestep">
                        <h3>Your ideal place</h3>
                        <h2>how long will your instructions be ? </h2>
                    </div>
                    ...
                    <div class="stepradio">
                      ...
                      <div class="stepform form-group">
                                <label class="titlestep">lenth of ench instruction ?</label>
                            ...
                            <div class="stepform form-group">
                                <label class="titlestep">break beetween instruction ?</label>
                               <select name="internet" id="internet" class="form-control">
                      ...
                      <div class="error"><p></p></div>
                           ...
                           <div class="row">
                               <div class="col-4">
                               <div class="stepform form-group">
                                    <label class="titlestep">Date </label>
                                    <div class="" id="jkmg">
                                      
                                        <input type="date" name="" value=""  placeholder="Select A Date">
                                        <br> <small>Lorem ipsum dolor sit amet.</small>
                               ...
                               <div class="col-3">
                               <div class="stepform form-group">
                                    <label class="titlestep">Start </label>
                                    <div class="" id="jkmg">
                                      
                                        <input type="time" name="" value=""  placeholder="Select A Date">
                               ...
                               <div class="col-3">
                               <div class="stepform form-group">
                                    <label class="titlestep">And </label>
                                    <div class="" id="jkmg">
                               ...
                               <div class="col-2" id="dreat">
                           
                                <a href="" id="dbtn"> <i class="fa fa-trash-o" aria-hidden="true"></i>Delete</a>
                               </div>
                           </div>
                           ...
                           <div class=" umesht">
                               <div class="  umeshtime">
                                ...
                                <a href="https://okroomie.com/find-me-a-room/demostep2" id="ujs">
