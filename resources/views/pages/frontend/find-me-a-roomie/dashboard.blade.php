...
<body>
        ...
        <header class="step-header">
            <div class="container">
                <div class="inner-block">
                    <div class="left">
                        <a href="javascript:history.go(-1)" aria-label="Go back" class="header-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="black" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M11.3 1.1a.5.5 0 0 1 .1.7L6.5 7l5.9 5.9a.5.5 0 0 1-.7.7l-6.5-6.5a.5.5 0 0 1 0-.7l6.5-6.5a.5.5 0 0 1 .7 0z" />
                            </svg><span class="header-icon"> Back</span>
                        </a>
                    </div>
                    <div class="logo">
                        <a href="{{url('/')}}">
                            <img src="https://okroomie.com/public/assets/frontend/images/logonk.png" alt="Your Logo" />
                        </a>
                    </div>
                    <div class="right">
                        <a href="{{url('/')}}" aria-label="Close" class="header-link">
                            ...
                            </svg> <span class="header-icon">Close</span>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div id="carouselExample" class="carousel slide" data-ride="carousel" data-interval="false">
            <ol class="carousel-indicators"> 
                @foreach($room_image as $k => $room_imageVal)
                    <li data-target="#carouselExample" data-slide-to="{{ $k }}" class="{{ $k == 0 ? 'active' : '' }}"></li>
                @endforeach
            </ol>
            <div class="carousel-inner row w-100 mx-auto slidermain" role="listbox">
                @foreach($room_image as $k => $room_imageVal)
                    <div class="carousel-item col-md-4 {{ $k == 0 ? 'active' : '' }}" aria-label="Slide {{ $k + 1 }}">
                        <div class="panel panel-default">
                            <div class="panel-thumbnail">
                                <img class="img-fluid mx-auto d-block" src="{{ url('public/images/'.$room_imageVal->image) }}" alt="Slide {{ $k + 1 }}">
                                <div class="carousel-caption">
                                    <h5>Image Caption {{ $k + 1 }}</h5>
                                    <p>Image Description {{ $k + 1 }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <a class="carousel-control-prev" href="#carouselExample" role="button" data-slide="prev" aria-label="Previous">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next" href="#carouselExample" role="button" data-slide="next" aria-label="Next">
        ...
        <!-- for responsive -->
        <section class="sliderss px-4">
    <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="img_div">
                    <img class="d-block w-100" src="{{url('public/images/'.$room_image[0]->image)}}" data-link="{{url('public/images/'.$room_image[0]->image)}}" alt="Image of {{ $room_image[0]->image }}">
                </div>
            </div>
            @foreach($room_image as $key => $room_imageVal)
                ...
                <div class="carousel-item">
                    <div class="img_div">
                        <img class="d-block w-100" src="{{url('public/images/'.$room_imageVal->image)}}" data-link="{{url('public/images/'.$room_imageVal->image)}}" alt="Image of {{ $room_imageVal->image }}">
                    </div>
                </div>
            @endforeach
        </div>
